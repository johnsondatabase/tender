...
export const translations = {
    vi: {
        ...
        // Submit / Nộp Thầu Modal
        submit_modal_title: "Xác nhận Nộp Thầu",
        submit_modal_desc: "Cập nhật thông tin chi tiết trước khi hoàn tất.",
        submit_full: "Nộp toàn phần",
        submit_partial: "Nộp 1 phần",
        submit_adjust_materials: "Điều chỉnh số lượng nộp:",
        submit_save: "Lưu & Hoàn Tất",
        lbl_submitted: "SL nộp",
        // Common Confirmations
        confirm_unsaved_close: "Bạn có thay đổi chưa lưu. Bạn có chắc chắn muốn đóng?",
        confirm_delete_items: "Bạn có chắc muốn xóa {n} sản phẩm?",
        confirm_delete_selected: "Bạn có chắc chắn muốn xóa {n} sản phẩm đã chọn?",
        confirm_delete_image: "Bạn có chắc muốn xóa ảnh này?",
        confirm_logout: "Bạn có chắc chắn muốn đăng xuất?",
        confirm_change_role: "Bạn có muốn đổi quyền của {gmail} thành {role}?",
        confirm_delete_account: "Bạn có chắc muốn xóa vĩnh viễn tài khoản của {name}? Hành động này không thể hoàn tác.",
        dup_detect_title: "Phát hiện trùng lặp dữ liệu",
        confirm_view_tender_detail: "Bạn có muốn xem chi tiết thầu cho mã này?",
        
        // Win Modal & History
        win_modal_title: "Xác nhận Thắng Thầu (Win)",
        win_modal_desc: "Cập nhật thông tin trước khi hoàn tất thắng thầu.",
        win_full: "Win toàn phần",
        win_partial: "Win 1 phần",
        win_save: "Lưu & Hoàn Tất",
        win_type_label: "Loại hình thắng thầu:",
        win_adjust_materials: "Điều chỉnh số lượng trúng:",
        history_title: "Lịch sử hoạt động",
        
        // Generic Errors & Info
        err_load_data: "Lỗi tải dữ liệu: {msg}",
        err_save_listing: "Lỗi lưu dữ liệu Listing: {msg}",
        import_success: "Import dữ liệu thành công!",
        import_error: "Lỗi khi import dữ liệu: {msg}",
        prod_add_success: "Thêm mới thành công",
        prod_delete_success: "Đã xóa thành công",
        prod_delete_error: "Lỗi xóa sản phẩm: {msg}",
        select_dates_error: "Vui lòng chọn cả ngày bắt đầu và kết thúc.",
        no_images: "Không có ảnh để tải.",
        download_complete: "Tải xuống hoàn tất.",
        zip_error: "Lỗi khi tạo file zip.",
        export_success: "Xuất Excel thành công!",
        export_error: "Lỗi khi xuất Excel: {msg}",
        prod_update_error: "Lỗi cập nhật: {msg}",
        prod_code_exists: "Mã vật tư đã tồn tại.",
        err_materials_empty: "Danh sách vật tư không được để trống.",
        err_materials_invalid: "Vui lòng nhập đầy đủ Mã VT và Số lượng (Quota > 0) cho tất cả các dòng.",
        err_ma_thau_exists: "Mã thầu '{id}' đã tồn tại.",
        warn_save_detail_fail: "Cảnh báo: Lưu chi tiết thất bại: {msg}",
        btn_data: "Data",
        btn_permission: "Phân quyền",
        reset_password_title: "Đặt lại mật khẩu",
        reset_password_for: "Cho tài khoản: {gmail}",
        
        // Viewer Config / User Management
        viewer_config_title: "Cấu hình xem dữ liệu",
        viewer_config_desc: "Chọn người dùng/PSR mà tài khoản này có thể xem dữ liệu của họ.",
        viewer_search_placeholder: "Tìm kiếm người dùng/PSR...",
        viewer_no_data: "Đang tải danh sách...",
        viewer_save_config: "Lưu cấu hình",
    ...
    en: {
        ...
        // Viewer Config / User Management (EN)
        viewer_config_title: "Viewer Configuration",
        viewer_config_desc: "Select users/PSR this account can view data for.",
        viewer_search_placeholder: "Search users/PSR...",
        viewer_no_data: "Loading list...",
        viewer_save_config: "Save Configuration",
        ...
        // Submit Modal
        submit_modal_title: "Submit Listing",
        submit_modal_desc: "Update submission details before completing.",
        submit_full: "Submit Full",
        submit_partial: "Submit Partial",
        submit_adjust_materials: "Adjust submitted quantities:",
        submit_save: "Save & Complete",
        lbl_submitted: "Submitted",
        // Common Confirmations
        confirm_unsaved_close: "You have unsaved changes. Are you sure you want to close?",
        confirm_delete_items: "Are you sure you want to delete {n} products?",
        confirm_delete_selected: "Are you sure you want to delete {n} selected products?",
        confirm_delete_image: "Are you sure you want to delete this image?",
        confirm_logout: "Are you sure you want to log out?",
        confirm_change_role: "Do you want to change the role of {gmail} to {role}?",
        confirm_delete_account: "Are you sure you want to permanently delete {name}'s account? This action cannot be undone.",
        dup_detect_title: "Duplicate detected",
        confirm_view_tender_detail: "Open tender detail for this code?",
        
        // Win Modal & History
        win_modal_title: "Confirm Win",
        win_modal_desc: "Update details before completing a win.",
        win_full: "Win Full",
        win_partial: "Win Partial",
        win_save: "Save & Complete",
        win_type_label: "Win type:",
        win_adjust_materials: "Adjust won quantities:",
        history_title: "Activity History",
        
        // Generic Errors & Info
        err_load_data: "Error loading data: {msg}",
        err_save_listing: "Error saving Listing: {msg}",
        import_success: "Import successful!",
        import_error: "Import error: {msg}",
        prod_add_success: "Add successful",
        prod_delete_success: "Delete successful",
        prod_delete_error: "Product delete error: {msg}",
        ...
        export_error: "Error exporting Excel: {msg}",
        prod_update_error: "Update error: {msg}",
        prod_code_exists: "Product code already exists.",
        err_materials_empty: "Material list cannot be empty.",
        err_materials_invalid: "Please enter valid Product Code and Quantity (Quota > 0) for all rows.",
        err_ma_thau_exists: "Tender code '{id}' already exists.",
        warn_save_detail_fail: "Warning: Failed to save details: {msg}",
        btn_data: "Data",
        btn_permission: "Permission",
        reset_password_title: "Reset Password",
        reset_password_for: "For account: {gmail}",
